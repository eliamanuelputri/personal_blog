...
<head>
    ...
    <title>Portofolio | Elia Manuel Putri</title>
...
<body class="index-page">
    ...
    <header id="header" class="header d-flex align-items-center sticky-top">
        <div class="container-fluid position-relative d-flex align-items-center justify-content-between">
            ...
            <a href="index.html" class="logo d-flex align-items-center me-auto me-xl-0">
                ...
                <h1 class="sitename">Elia Manuel</h1>
            ...
            <nav id="navmenu" class="navmenu">
                <ul>
                    ...
                    <li><a href="#portfolio">My Mini Project</a></li>
    ...
    <main class="main">
            ...
            <div class="container d-flex flex-column justify-content-center align-items-center text-center position-relative">
                <div class="hero-content d-flex">
                    <div class="hero-image">
                        <img src="/assets/img/woman.png" class="img-fluid animated" alt="" style="">
                    </div>
                    <div class="name">
                        <h2>Halo, Saya </h2>
                        <h1> Elia Manuel</h1>
        ...
        {{-- <section id="hero" class="hero section">
            <div class="container d-flex flex-column justify-content-center align-items-center text-center position-relative"
                data-aos="zoom-out">
                <img src="/assets/img/woman.png" class="img-fluid animated" alt="">
